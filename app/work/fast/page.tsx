  ...
  return (
    <main style={{ paddingTop: '8rem', paddingBottom: '4rem', minHeight: '100vh' }}>
      ...
      >
        ...
        <div style={{ gridColumn: '3', gridRow: '2', background: 'linear-gradient(145deg, #fce4ec, #f06292)', borderRadius: '2px' }}></div>
        <div style={{ gridColumn: '1', gridRow: '3', background: 'linear-gradient(145deg, #f06292, #d81b60)', borderRadius: '2px' }}></div>
        <div style={{ gridColumn: '2', gridRow: '3', background: 'linear-gradient(145deg, #fce4ec, #ffb6c1)', borderRadius: '2px' }}></div>
        <div style={{ gridColumn: '3', gridRow: '3', background: 'linear-gradient(145deg, #f8bbd0, #e91e63)', borderRadius: '2px' }}></div>
      </motion.div>
    </main>
  );
}
